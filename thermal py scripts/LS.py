...
def Lippmann_Schwinger(C0, N, xi, c, E_bar, L, epsilon):
    ...
    while True:
        ...
        tau_hat[...,0] = fftn(tau[...,0],norm="backward", workers=-1)
        tau_hat[...,1] = fftn(tau[...,1],norm="backward", workers=-1)
        ...
        idx = (xi[...,0]==0) 
        norm2[idx] = 1. # invalid value encountered in divide set to 1
        ...
        #if iteration < 10 :
            #print("tau_hat %d:" %(iteration), tau_hat)
            #break
